  ...
  <div class="container">
      ...
      <nav class="navbar bg-body-tertiary">
        ...
        <div class="row justify-content-left">
          <div class="col-md-200">
            <form class="row g-2" method="POST" action="solvencias_ilobasco.php">
              <div class="col-md-10">
    ...
    if ($resultado = $mysqli->query($consulta)) {
      ...
      while ($fila = $resultado->fetch_row()) {
        ...
        echo "<td class='border-bottom'><a href='imprimir_ilobasco.php?var=$fila[6]'><button type='button' class='btn btn-dark'>Imprimir</button></a></td>";
        echo "<td class='border-bottom'><a href='descargar_ilobasco.php?var=$fila[6]'><button type='button' class='btn btn-dark'>Descargar</button></a></td>";
