...
<html lang="en">
  ...
  <body style="background-color: #fff;">
    ...
    <div class="col-md-4">
      <br><h5><a href="http://www.catalogo.catolica.edu.sv/cgi-bin/koha/Solvencia/versolvenciasbri.php">Biblioteca Regional Ilobasco</a>/Solvencia</h5>
      </div>
     </div>
    </div>
    <!-- end top -->
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10"><!-- seccion centro -->
          ...
          <form class="form-signin  col-md-10" method="POST" action="solvenciaonlinebri.php">
            <div class="col-md-4">
...
if ($result = $mysqli->query("SELECT DATABASE()")) {
    ...
    $result->close();
         ...
         $consulta = "SELECT carnet, nombres, apellidos, carrera, fechasolicitud, tiposolvencia, codsolicitadas, estado FROM `solicitadas` WHERE email = '' AND impreso = '' AND facultad = '$ilobasco' AND (carnet LIKE '%$buscar%' OR nombres LIKE '%$buscar%' OR apellidos LIKE '%$buscar%' OR carrera LIKE '%$buscar%') ORDER BY fechasolicitud DESC ";
           ...
           echo "<table class='bordered'>";
             ...
             while ($fila = $resultado->fetch_row()) {
                     ...
                     echo "<tr>";
                         ...
                         echo "<td><a href='imprimirbri.php?var=$fila[6]'><button type='button' class='btn btn-link'>Imprimir</button></a></td>";//autor
