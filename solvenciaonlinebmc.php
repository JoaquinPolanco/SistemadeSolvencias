...
<html lang="en">
  ...
  <body style="background-color: #fff;">
    ...
    <div class="col-md-4">
      <br><h5><a href="http://www.catalogo.catolica.edu.sv/cgi-bin/koha/Solvencia/versolvenciasbmc.php">Biblioteca Miguel de Cervantes</a>/Solvencia</h5>
      </div>
     </div>
    </div>
    <!-- end top -->
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10"><!-- seccion centro -->
          ...
          <form class="form-signin  col-md-10" method="POST" action="solvenciaonlinebmc.php">
            <div class="col-md-4">
