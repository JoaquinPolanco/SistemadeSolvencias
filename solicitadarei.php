...
echo "<h4><b>$titulo $nombre $apellido</b>, estudiante de la carrera de <b>$carrera</b>, con el n&uacute;mero de carnet: <b>$carnet</b>. Haz solicitado tu solvencia de forma exitosa.</p></h4>";
echo "<br>";
echo "<h3>Recuerda:</h3>";
